    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="aboutus.php#about" >About Us</a></li>
         
          <li class="menu-active"><a href="projects.php">projects</a></li>
          <li><a href="teams.php#team">Teams</a></li>
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="img/intro-carousel/3jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
              </div>
...
<?php
$count=1;
$sel_query="Select * from devlopers_tb ORDER BY empid desc;";
